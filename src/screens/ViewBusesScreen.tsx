                    ...
                    <div className='flex h-full w-full justify-center'>
                        <div className='flex w-full max-w-7xl flex-col items-center'>
                            <div className='flex w-full justify-between'>
                                ...
                                <div className='flex flex-1 justify-end '>
                                    <div className='border-1 float-right mr-6 box-border flex h-28 w-52 items-center rounded-md bg-white shadow-lg shadow-indigo-400/20'>
                                        <h1 className='border-color-gray bg-green ml-4 rounded-full border px-5 py-4 text-white'>
                                            {totalBuses}
                                        </h1>
                                    ...
                                    <div className='border-1 box-border flex h-28 w-52 items-center bg-white shadow-lg shadow-indigo-400/20'>
                                        <h1 className='border-color-gray bg-red ml-4 rounded-full border px-5 py-4 text-white'>{totalSeats}</h1>
                            ...
                            <div className='relative w-full shadow-md shadow-indigo-400/20'>
                                <div>
                                    {errortext ? (
                                        <h1 className='text-red -mt-3 mb-3'>No Bus found on this route</h1>
                                    ) : (
                                ...
                                >
                                    <Form className='flex w-full'>
                                        <div className='flex flex-1 justify-between '>
                                            <div className='flex w-[45%] min-w-[15rem] cursor-pointer rounded-lg py-3 px-4 font-semibold text-gray-500'>
